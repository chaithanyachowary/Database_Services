            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="create.php" class="btn btn-primary pull-right">Add New Salary</a>
                    </div>
                    <?php
                    // Include config file
                    ...
                    if ($result = mysqli_query($link, $sql)) {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<td>";
                                echo "<a href='read.php?id=" . $row['SalaryID'] . "' title='View Record' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
                                echo "<a href='update.php?id=" . $row['SalaryID'] . "' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                echo "<a href='delete.php?id=" . $row['SalaryID'] . "' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                echo "</td>";
                                echo "</tr>";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn-primary" id="btn-join">Salary data for every
                            employee</button>
                        <button type="button" class="btn btn-primary" id="btn-subquery">Highest salary amount and the
                            corresponding employee's name</button>
